// Простой скрипт для тестирования отправки изображения в Telegram с ES модулями
...
if (args.length < 3) {
  console.error('Использование: node test-telegram-esm.js TELEGRAM_TOKEN CHAT_ID IMAGE_URL');
  process.exit(1);
}
