...
const ENHANCEMENT_PROMPTS = [
  {
    id: "improve",
    name: "Улучшить текст",
    prompt: "Улучши этот текст, сделай его более привлекательным и интересным для чтения. Сохрани стиль и формат, но сделай его более ярким и запоминающимся. ВАЖНО: Используй **жирный текст** для ключевых слов, *курсив* для акцентов, ~~зачеркнутый~~ для изменений, __подчеркнутый__ для важных моментов в markdown формате."
  },
  {
    id: "shorten",
    name: "Сократить текст",
    prompt: "Сократи этот текст, сохранив его основной смысл и ключевые тезисы. Убери повторения и лишние детали. ВАЖНО: Используй **жирный текст** для ключевых слов, *курсив* для акцентов, ~~зачеркнутый~~ для удаленных частей, __подчеркнутый__ для важного в markdown формате."
  },
  {
    id: "expand",
    name: "Расширить текст",
    prompt: "Расширь и дополни этот текст деталями, примерами и пояснениями. Сделай его более информативным и полным. ВАЖНО: Используй **жирный текст** для ключевых слов, *курсив* для акцентов, ~~зачеркнутый~~ для сравнений, __подчеркнутый__ для важного в markdown формате."
  },
  {
    id: "friendly",
    name: "Сделать дружелюбнее",
    prompt: "Перепиши текст в более дружелюбном, разговорном стиле. Добавь личных обращений, замени формальные выражения на более простые и теплые. ВАЖНО: Используй **жирный текст** для ключевых слов, *курсив* для эмоций, ~~зачеркнутый~~ для контрастов, __подчеркнутый__ для важного в markdown формате."
  },
  {
    id: "professional",
    name: "Сделать профессиональнее",
    prompt: "Перепиши текст в более профессиональном стиле. Сделай его формальным, структурированным и солидным. Используй деловой тон. ВАЖНО: Используй **жирный текст** для ключевых терминов, *курсив* для акцентов, ~~зачеркнутый~~ для сравнений, __подчеркнутый__ для важного в markdown формате."
  },
  {
    id: "fix",
    name: "Исправить ошибки",
    prompt: "Исправь в тексте грамматические, стилистические и пунктуационные ошибки. Улучши структуру предложений, сохраняя исходный смысл. ВАЖНО: Используй **жирный текст** для ключевых слов, *курсив* для акцентов, ~~зачеркнутый~~ для исправлений, __подчеркнутый__ для важного в markdown формате."
  },
  {
    id: "emoji",
    name: "Добавить эмодзи",
    prompt: "Добавь в текст уместные эмодзи, чтобы сделать его более ярким и привлекательным. Размести эмодзи рядом с соответствующими тезисами. ВАЖНО: Используй **жирный текст** для ключевых слов, *курсив* для акцентов, ~~зачеркнутый~~ для контрастов, __подчеркнутый__ для важного в markdown формате."
  }
];
