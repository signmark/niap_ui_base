...
app.post("/api/generate-content", authenticateUser, async (req, res) => {
  ...
  if (useCampaignData) {
    try {
      ...
      // Добавляем данные компании если они есть
...
**Итоговый промпт с данными кампании (включая ключевые слова):**
```
Создай пост о здоровом питании для Instagram

Ключевые слова: правильное питание, здоровый образ жизни, доставка еды, фитнес питание
