...
- July 24, 2025. DOMAIN MIGRATION TO ROBOFLOW.SPACE: Updated all environment variables from expired roboflow.tech domain to roboflow.space. Updated DIRECTUS_URL, VITE_DIRECTUS_URL, N8N_URL, VITE_N8N_URL to use new domain. DNS propagation in progress (approximately 1 hour). This resolves SSL connection errors in scheduler and status checker services.
