  ...
  app.post("/api/website-analysis", authenticateUser, async (req: any, res) => {
    ...
    try {
      ...
      try {
        ...
        // Создаем простую строку промпта вместо массива сообщений
...
Верни только JSON объект с полями:
{
  ...
  "mainProducts": "Основные товары/услуги",
  "competitiveAdvantages": "Конкурентные преимущества",
  "businessGoals": "Цели бизнеса",
  "currentChallenges": "Текущие вызовы",
  "marketingBudget": "Бюджет на маркетинг (если указан)",
  "preferredChannels": "Предпочитаемые каналы продвижения"
}
