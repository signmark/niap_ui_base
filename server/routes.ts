...
ВАЖНО:
- Никогда не предваряй ответ фразами вроде "Вот контент для вашего поста" или "Вот улучшенный текст".
- Начинай ответ сразу с тега \<h1\> или \<h2\> для заголовка.
- Сохраняй все HTML-теги в тексте, они не должны быть удалены или экранированы.
- Не заключай HTML в кодовые блоки (никаких \`\`\`html или \`\`\`).
- Не используй символы &lt; и &gt; вместо \< и \> для HTML-тегов.
- НЕ ДОБАВЛЯЙ НИКАКИХ КОММЕНТАРИЕВ, МЕТАИНФОРМАЦИИ ИЛИ ОБЪЯСНЕНИЙ ИЗМЕНЕНИЙ.
- НЕ ДОБАВЛЯЙ фразы типа "Изменения и улучшения" или "Добавлены списки" - ПРОСТО ОТДАЙ ТОЛЬКО ЧИСТЫЙ ТЕКСТ.`;
