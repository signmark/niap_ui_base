...
Проведи глубокий анализ аудитории: демографические особенности, интересы, стиль общения, популярные темы, уровень вовлеченности, типы реакций.
...
Ответь строго в JSON формате:
{
  ...
  "summary": "краткое_описание_общей_тональности_комментариев",
  "detailed_summary": "подробный_анализ_характеристик_аудитории_включая_демографию_интересы_стиль_общения_популярные_темы_уровень_вовлеченности_типичные_реакции_и_поведенческие_особенности_участников_обсуждений"
}`;
