...
2. СОХРАНИ все HTML-теги и форматирование из исходного текста (например, <b>, <strong>, <i>, <em>, <br>, <p> и т.д.).
3. НЕ добавляй новые эмодзи, звездочки, дефисы для разделения.
4. НЕ добавляй заголовки, подзаголовки или структурные элементы типа "---".
5. НЕ заключай ответ в кавычки, теги code или markdown-разметку.
6. Сохрани исходный стиль, тон и структуру текста.
7. НЕ превращай текст в "маркетинговую кашу" со списками и призывами к действию.
8. Если в тексте есть HTML-теги для выделения (**текст**, <b>текст</b>), сохрани их.
9. Ответ должен начинаться сразу с первой буквы улучшенного текста.
