/**
 * Общие утилиты для форматирования HTML-текста для Telegram (Common JS версия)
 * Этот файл содержит функции, которые можно использовать из Common JS модулей
 */
 ...
 */
function formatHtmlForTelegram(htmlContent) {
  ...
  try {
    ...
    console.error(`Ошибка форматирования HTML для Telegram: ${error.message}`);
